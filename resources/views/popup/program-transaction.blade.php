    ...
    <div class="popup" id="popup">
        ...
        <form id="programmedTransactionForm" method="POST" action="{{ route('schedule.store') }}">
            ...
            <div class="form-group flex-container">
                ...
                <input type="checkbox" id="monthlyCheckBox" name="monthly">
                <label for="belowThreshold">Daily:</label>
                <input type="checkbox" id="dailyCheckBox" name="daily">
            </div>

            <div class="form-group flex-container">
                <label for="transaction-amount">Transaction Amount</label>
                <input id="transaction-amount" type="number" name="amount" value="0" min="0"
                    step="1" required />
            </div>
